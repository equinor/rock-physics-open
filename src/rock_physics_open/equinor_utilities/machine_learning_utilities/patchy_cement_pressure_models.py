...
from rock_physics_open.sandstone_models.patchy_cement_model import patchy_cement_model_dry


class PatchyCementDryBulkModulusPressureModel(BasePressureModel):
    """
    ...
    Input format (n,8): [phi, k_min, mu_min, rho_min, k_cem, mu_cem, rho_cem, p_eff_in_situ, p_eff_depleted]
    ...
    @classmethod
    def load(cls, file: Union[str, bytes]) -> "PatchyCementDryBulkModulusPressureModel":
        """
...
class PatchyCementDryShearModulusPressureModel(BasePressureModel):
    """
    Pressure sensitivity model using patchy cement dry rock properties.
    ...
    @classmethod
    def load(cls, file: Union[str, bytes]) -> "PatchyCementDryShearModulusPressureModel":
        """
        Load patchy cement model from pickle file.
